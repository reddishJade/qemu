     ...
     /* LSI Mega RAID Support */
     IOCTL(MEGASAS_IOC_FIRMWARE64, 0, TYPE_INT)
     IOCTL(MEGASAS_IOC_FIRMWARE32, 0, TYPE_INT)
     IOCTL(LINUX_SG_GET_VERSION_NUM, 0, TYPE_INT)
     IOCTL(LINUX_SG_IO, 0, TYPE_INT)

     /*mpt3sas Support */
     IOCTL(MPT3IOCINFO, 0, TYPE_INT)
     IOCTL(MPT3COMMAND, 0, TYPE_INT)
     IOCTL(MPT3BTDHMAPPING, 0, TYPE_INT)
